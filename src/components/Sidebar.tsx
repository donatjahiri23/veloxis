...
const navItems = [
  ...
  { href: "/identity", label: "Identity Graph", icon: "Fingerprint" },
  { href: "/campaigns", label: "Campaigns", icon: "Megaphone" },
  { href: "/history", label: "Performance", icon: "History" },
  { href: "/insights", label: "Insights", icon: "Insights" },
  { href: "/comparison", label: "Comparison", icon: "ArrowsCompare" },
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 bg-card-bg border border-card-border rounded-lg p-2 text-text-primary hover:bg-white/10 transition-colors"
      >
      ...
      <aside className={`fixed left-0 top-0 h-screen w-64 bg-sidebar-bg border-r border-card-border flex flex-col z-50 transition-transform duration-300 lg:translate-x-0 ${open ? "translate-x-0" : "-translate-x-full"}`}>
        <div className="p-6 border-b border-card-border flex items-center justify-between">
          ...
          <button
            onClick={() => setOpen(false)}
            className="lg:hidden text-muted hover:text-text-primary transition-colors"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
        ...
        <div className="p-4 border-t border-card-border space-y-3">
          ...
          <button
            onClick={toggle}
            className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-medium text-muted-light hover:text-text-primary hover:bg-hover-bg transition-all duration-200 border border-card-border"
          >
            ...
            <div className={`w-10 h-5 rounded-full relative transition-colors duration-300 ${theme === "dark" ? "bg-card-border" : "bg-accent"}`}>
              <div className={`absolute top-0.5 w-4 h-4 rounded-full bg-white shadow-sm transition-transform duration-300 ${theme === "dark" ? "left-0.5" : "left-5"}`} />
            </div>
          </button>
